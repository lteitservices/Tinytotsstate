...
import com.lteitservices.tinytotsstate.SettingActivity;
import com.lteitservices.tinytotsstate.TakeUrl;
import com.lteitservices.tinytotsstate.adapters.AcademicModuleAdapter;
import com.lteitservices.tinytotsstate.adapters.CommunicateModuleAdapter;
import com.lteitservices.tinytotsstate.adapters.ElearningModuleAdapter;
import com.lteitservices.tinytotsstate.adapters.LoginChildListAdapter;
import com.lteitservices.tinytotsstate.adapters.OtherModuleAdapter;
...
import com.lteitservices.tinytotsstate.utils.DrawerArrowDrawable;
...
//        }
       // makeText(this, Utility.getSharedPreferences(getApplicationContext(),Constants.currentLocale), Toast.LENGTH_SHORT).show();
        ...
        switchChildBtn.setOnClickListener(view -> showChildList());
       ...
       // other();
        ...
        notification_alert.setOnClickListener(view -> {

                DatabaseHelper db1 = new DatabaseHelper(NewDashboard.this);
                db1.updatestatus("0", "1");
